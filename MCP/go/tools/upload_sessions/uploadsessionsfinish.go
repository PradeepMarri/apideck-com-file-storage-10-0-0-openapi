...
func UploadsessionsfinishHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/file-storage/upload-sessions/%s/finish%s", cfg.BaseURL, id, queryString)
		...
		var result models.GetFileResponse
...
func CreateUploadsessionsfinishTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_file-storage_upload-sessions_id_finish",
		mcp.WithDescription("Finish Upload Session"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UploadsessionsfinishHandler(cfg),
	}
}
