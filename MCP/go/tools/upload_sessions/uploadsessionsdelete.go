...
func UploadsessionsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteUploadSessionResponse
...
func CreateUploadsessionsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_upload-sessions_id",
		mcp.WithDescription("Abort Upload Session"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UploadsessionsdeleteHandler(cfg),
	}
}
