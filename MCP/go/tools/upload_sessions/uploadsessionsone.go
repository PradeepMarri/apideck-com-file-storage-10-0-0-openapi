...
func UploadsessionsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetUploadSessionResponse
...
func CreateUploadsessionsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_upload-sessions_id",
		mcp.WithDescription("Get Upload Session"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UploadsessionsoneHandler(cfg),
	}
}
