...
func FilesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateFilesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_files_id",
