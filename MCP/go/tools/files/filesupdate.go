...
func FilesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateFileRequest
		...
		url := fmt.Sprintf("%s/file-storage/files/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateFileResponse
...
func CreateFilesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_file-storage_files_id",
		mcp.WithDescription("Rename or move File"),
		...
		mcp.WithString("name", mcp.Description("Input parameter: The name of the file.")),
		mcp.WithString("parent_folder_id", mcp.Description("Input parameter: The parent folder to create the new file within.")),
		mcp.WithString("description", mcp.Description("Input parameter: Optional description of the file.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    FilesupdateHandler(cfg),
	}
}
