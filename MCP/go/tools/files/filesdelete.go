...
func FilesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteFileResponse
...
func CreateFilesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_files_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    FilesdeleteHandler(cfg),
	}
}
