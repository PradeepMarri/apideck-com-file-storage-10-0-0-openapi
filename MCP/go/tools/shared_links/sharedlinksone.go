...
func SharedlinksoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetSharedLinkResponse
...
func CreateSharedlinksoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_shared-links_id",
		mcp.WithDescription("Get Shared Link"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SharedlinksoneHandler(cfg),
	}
}
