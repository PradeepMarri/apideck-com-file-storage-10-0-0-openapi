...
func SharedlinksaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/file-storage/shared-links%s", cfg.BaseURL, queryString)
		...
		var result models.CreateSharedLinkResponse
...
func CreateSharedlinksaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_file-storage_shared-links",
		mcp.WithDescription("Create Shared Link"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SharedlinksaddHandler(cfg),
	}
}
