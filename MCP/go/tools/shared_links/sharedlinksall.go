...
func SharedlinksallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetSharedLinksResponse
...
func CreateSharedlinksallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_shared-links",
		mcp.WithDescription("List SharedLinks"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SharedlinksallHandler(cfg),
	}
}
