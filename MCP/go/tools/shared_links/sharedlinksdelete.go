...
func SharedlinksdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteSharedLinkResponse
...
func CreateSharedlinksdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_shared-links_id",
		mcp.WithDescription("Delete Shared Link"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    SharedlinksdeleteHandler(cfg),
	}
}
