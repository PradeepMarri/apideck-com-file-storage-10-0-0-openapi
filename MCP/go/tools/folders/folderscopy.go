...
func FolderscopyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CopyFolderRequest
		...
		url := fmt.Sprintf("%s/file-storage/folders/%s/copy%s", cfg.BaseURL, id, queryString)
...
func CreateFolderscopyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_file-storage_folders_id_copy",
		mcp.WithDescription("Copy Folder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    FolderscopyHandler(cfg),
	}
}
