...
func FoldersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetFolderResponse
...
func CreateFoldersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_folders_id",
		mcp.WithDescription("Get Folder"),
