...
func FoldersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteFolderResponse
...
func CreateFoldersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_folders_id",
		mcp.WithDescription("Delete Folder"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    FoldersdeleteHandler(cfg),
	}
}
