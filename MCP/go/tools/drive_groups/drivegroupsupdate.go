...
func DrivegroupsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DriveGroup
		...
		url := fmt.Sprintf("%s/file-storage/drive-groups/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateDriveGroupResponse
...
func CreateDrivegroupsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_file-storage_drive-groups_id",
		mcp.WithDescription("Update DriveGroup"),
		...
		mcp.WithString("name", mcp.Required(), mcp.Description("Input parameter: The name of the drive group")),
		...
		mcp.WithString("display_name", mcp.Description("Input parameter: The display name of the drive group")),
		mcp.WithString("id", mcp.Required(), mcp.Description("Input parameter: A unique identifier for an object.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DrivegroupsupdateHandler(cfg),
	}
}
