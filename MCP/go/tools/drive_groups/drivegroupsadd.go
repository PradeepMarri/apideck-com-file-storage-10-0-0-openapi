...
func DrivegroupsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/file-storage/drive-groups%s", cfg.BaseURL, queryString)
		...
		var result models.CreateDriveGroupResponse
...
func CreateDrivegroupsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_file-storage_drive-groups",
		mcp.WithDescription("Create DriveGroup"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivegroupsaddHandler(cfg),
	}
}
