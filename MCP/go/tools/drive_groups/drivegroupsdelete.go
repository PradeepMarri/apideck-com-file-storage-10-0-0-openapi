...
func DrivegroupsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteDriveGroupResponse
...
func CreateDrivegroupsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_drive-groups_id",
		mcp.WithDescription("Delete DriveGroup"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivegroupsdeleteHandler(cfg),
	}
}
