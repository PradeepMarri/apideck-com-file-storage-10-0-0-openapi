...
func DrivegroupsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDriveGroupsResponse
...
func CreateDrivegroupsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_drive-groups",
		mcp.WithDescription("List DriveGroups"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivegroupsallHandler(cfg),
	}
}
