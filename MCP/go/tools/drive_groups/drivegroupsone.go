...
func DrivegroupsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDriveGroupResponse
...
func CreateDrivegroupsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_drive-groups_id",
		mcp.WithDescription("Get DriveGroup"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivegroupsoneHandler(cfg),
	}
}
