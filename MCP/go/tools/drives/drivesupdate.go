...
func DrivesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/file-storage/drives/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateDriveResponse
...
func CreateDrivesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_file-storage_drives_id",
		mcp.WithDescription("Update Drive"),
		...
		mcp.WithString("name", mcp.Required(), mcp.Description("Input parameter: The name of the drive")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivesupdateHandler(cfg),
	}
}
