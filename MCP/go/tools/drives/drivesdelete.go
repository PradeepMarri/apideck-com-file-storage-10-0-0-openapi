...
func DrivesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteDriveResponse
...
func CreateDrivesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_file-storage_drives_id",
		mcp.WithDescription("Delete Drive"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DrivesdeleteHandler(cfg),
	}
}
