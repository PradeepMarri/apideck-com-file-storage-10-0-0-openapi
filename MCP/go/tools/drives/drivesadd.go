...
func DrivesaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/file-storage/drives%s", cfg.BaseURL, queryString)
		...
		var result models.CreateDriveResponse
...
func CreateDrivesaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_file-storage_drives",
		mcp.WithDescription("Create Drive"),
