...
func DrivesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDrivesResponse
...
func CreateDrivesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_file-storage_drives",
		mcp.WithDescription("List Drives"),
